...
uint16_t medExponents[] = {0, 1, 3, 5, 16, 18, 23, 27, 29, 31, 0x8000};
uint16_t medFracts[] = {0x001, 0x004, 0x00f, 0x4f7, 0x555, 0x693, 0x900, 0xcd3, 0xded, 0xfe6, 0x8000};

// lists of fma_1 and fma_2 tests
uint16_t medLiteExponents[] = {0, 5, 16, 29, 31, 0x8000};
...
uint16_t specialLiteExponents[] = {0, 5, 16, 29, 31, 0x8000};
